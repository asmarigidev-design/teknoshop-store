...
import { DATAPRODUCT } from '../testimonialsSlider/data';
import { FaShoppingCart, FaHome, FaStore } from 'react-icons/fa';  // وارد کردن آیکون‌ها | Import icons
import CustomModal from '../CustomModal/CustomModal';  
import TestimonialsSlider from '../testimonialsSlider/TestimonialsSlider';  // وارد کردن TestimonialsSlider | Import TestimonialsSlider
import OriginalModal from '../OriginalModal/OriginalModal';  // وارد کردن OriginalModal | Import OriginalModal

// تعریف کامپوننت MobileContent | Define MobileContent component
const MobileContent = () => {  
      ...
      <div className="products">  
        {DATAPRODUCT.map(product => (  
          <div className="card" key={product._id}>  
            <div className="specifications" onClick={() => handleProductClick(product)}>  
              <img  
