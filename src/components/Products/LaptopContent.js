...
import { DATAPRODUCTT } from '../testimonialsSlider/data';
...
import { FaShoppingCart, FaHome, FaStore } from 'react-icons/fa'; // وارد کردن آیکون‌های جدید | Import new icons

// تعریف کامپوننت LaptopContent | Define LaptopContent component
const LaptopContent = () => {  
